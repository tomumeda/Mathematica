...
accumBSM[item_]:=Block[{},$defBSM=tuAppendUniq[item][$defBSM];""];
selectBSM[heads_,with_:{},all_:Null]:=tuRuleSelect[$defBSM][Flatten[{heads}]]//Select[#,tuHasAllQ[#,Flatten[{with}]]&]&//If[all===Null,Last[#],Select[#,tuHasNoneQ[#,Flatten[{all}]]&]]&;
Clear[expandDC];
expandDC[sub_:{},scalar_:{},func_:{}]:=tuRepeat[{sub,tuOpDistribute[Dot],tuOpSimplify[Dot,scalar],tuOpDistribute[CircleTimes]},{tuCircleTimesSimplify,func}]
Clear[expandCom]
