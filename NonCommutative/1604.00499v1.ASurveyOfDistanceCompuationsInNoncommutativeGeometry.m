...
accumDist[item_]:=Block[{},$defDist=tuAppendUniq[item][$defDist];""];
selectDist[heads_,with_:{},all_:Null]:=tuRuleSelect[$defDist][Flatten[{heads}]]//Select[#,tuHasAllQ[#,Flatten[{with}]]&]&//If[all===Null,Last[#],#]&;
Clear[expandDC];
