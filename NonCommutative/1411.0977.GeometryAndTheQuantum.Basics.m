...
Subscript[("\[Del]"), n_]:=T["\[Del]","d",{n}]*)

accumGQ[item_]:=Block[{},$defGQ=tuAppendUniq[item][$defGQ];""];
selectGQ[heads_,with_:{},all_:Null]:=tuRuleSelect[$defGQ][Flatten[{heads}]]//Select[#,tuHasAllQ[#,Flatten[{with}]]&]&//If[all===Null,Last[#],#]&;
Clear[expandDC];
