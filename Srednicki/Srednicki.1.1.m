...
DefineTensorShortcuts[{{x,y,dx,\[Xi],b,r,zero,\[CurlyPhi],\[Psi],\[Psi]c},1},{{g,\[Delta] ,\[Sigma],zero,\[Omega],\[Omega]1,\[Omega]2,\[Omega]s,\[Omega]a,\[Eta],\[CapitalLambda],A,B},2},{{\[CapitalGamma],\[Epsilon]},3}]
