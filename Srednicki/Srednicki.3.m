...
DefineTensorShortcuts[{{\[CurlyPhi]},0},{{x,y,dx,\[Xi],b,r,zero,\[CurlyPhi],\[Psi],\[Psi]c,J,K,P,a,k,e,p},1},{{x,k,g,\[Delta] ,\[Sigma],zero,\[Omega],\[Omega]1,\[Omega]2,\[Omega]s,\[Omega]a,\[Eta],\[CapitalLambda],A,B,M,\[Delta]\[Omega],\[Delta]\[Alpha]},2},{{\[CapitalGamma],\[Epsilon]},3}]
