...
(* ::Input::Initialization:: *)
accumLabel="Hossenfelder";
$def[accumLabel]={};
accumHF=accum[accumLabel];
selectHF=select[accumLabel];
defHF:=$def[accumLabel]

Get[NBname["dir"]<>"/1611.02269Emergent Gravity and the Dark Universe.out"]
$def["EntropicGrav"]
selectEG:=select["EntropicGrav"]
